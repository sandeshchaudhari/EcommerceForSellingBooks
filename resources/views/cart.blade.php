                                ...
                                @foreach(Cart::content() as $pdt)
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-remove">
                                            <a href="{{route('cart.destroy',['id'=>$pdt->rowId])}}" class="product-del remove" title="Remove this item">
                                        ...
                                        <td class="product-thumbnail">
                                            ...
                                            <div class="cart-product__item">
                                                <a href="#">
                                                    <img src="{{asset('uploads/products/book.png')}}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                                </a>
